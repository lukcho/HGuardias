...
//		}
	...
	/**
	 * finder Gen�rico que devuelve todos las entidades de una tabla. Esta versi�n
	 * no cierra la transacci�n, para que el Manager que la invoque lo haga.
	 * 
	 * @param clase
	 *            La clase que se desea consultar.
	 * @param orderBy
...
//			
    ...
    /**
     * Ejecuta una b�squeta analizando una fecha
     * @param clase
     * @param where
     * @param param
     * @param date
