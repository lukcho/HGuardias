...
insert into hg_lugares  values (default, 'Centro de emprendimiento',3,'Urcuquí','A',false,false);
insert into hg_lugares  values (default, 'CCTV',4,'Urcuquí','A',false,false);
...
insert into hg_lugares  values (default, 'Chalet',3,'Urcuquí','A',true,true);
insert into hg_lugares  values (default, 'Ingenio',3,'Urcuquí','A',true,false);
insert into hg_lugares  values (default, 'Casas Patrimoniales',3,'Urcuquí','A',true,false);
insert into hg_lugares  values (default, '40 Casas',3,'Urcuquí','A',true,false);
insert into hg_lugares  values (default, 'Bloques',3,'Urcuquí','A',true,true);
insert into hg_lugares  values (default, 'Centro de enrolamiento',3,'Urcuquí','A',true,true);
